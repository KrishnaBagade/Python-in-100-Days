...
print(
    "You are the first explorers to arrive at the island.You are at the starting point."
)
...
''')
    ...
    if choice == "yes":
      ...
      print("Your adventure is ending.")
      print(
          '''                                             __----~~~~~~~~~~~------___
                                 .  .   ~~//====......          __--~ ~~
                 -.            \\_|//     |||\\  ~~~~~~::::... /~
                ...
                \\          |- - -  - -  - - | _--~|
                 \\        |                |//.-~~-\
                  \\X__x___ ==================*
                   ~---,____--~~*''')
      print(
          "You have got a treasure chest and leave a dragon comes and destroys the castle."
      )
    elif choice == "no":
      print('''   / \
 / '.\
...
''')
      choice = input(
          "You see a well in front of you after walking away from the castle. enter the well?"
      )
      if choice == "yes":
        print(''',,
`""*$b..
...
''')
        ...
        if choice == "no":
          print(
              "Your character got tired of walking your adventure is ending. To be continued...(till the next installment)"
          )
