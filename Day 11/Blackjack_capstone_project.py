...
def check_for_ace(user_card, index):
  if "11" in user_card[index]:
    print(user_card)
    user_choice = input("You have drawn an ace do you want to use it as 1 or 11? ")
    user_card.remove("11")
    if user_choice == "11":
      user_card.append(user_choice)
      return user_card
    else:
      user_card.append("1")
      return user_card
...
while True:
  ...
  if bet_amount.isdigit():
    ...
    if user_card_value == 21:
      ...
      while True:
        ...
        if user_chose == "hit":
          ...
          if user_card_value == 21:
            ...
            print(f"You drew a {user_drawn_card[2]} of {card_category[random.randint(0,3)]}, You went over 21."
                  f" You lose.")
            bet -= bet_amount_i
            break
      ...
      if 21 <= user_count > computer_count:
        print(f"Your hand score was {user_card_value} and Dealer's hand score was {computer_card_value}, You lose"
              f" ${bet_amount_i}.")
        bet -= bet_amount_i
       ...
       print(f"Your hand score was {user_card_value} and Dealer's hand score was {computer_card_value}, You win"
             f" ${bet_amount_i}.")
       bet += bet_amount_i
       continue_ = input("Do you wish to go again 'y' or 'n' ? ").lower()
       if continue_ == "n":
        ...
        print(f"Your hand score was {user_card_value} and Dealer's hand score was {computer_card_value}, Its a draw you"
              f" keep your ${bet_amount_i}.")
        continue_ = input("Do you wish to go again 'y' or 'n' ? ").lower()
        if continue_ == "n":
         break
  else:
